...
try {
  ...
  fail("This branch has no upstream. Push it with: git push -u origin HEAD");
...
if (status) {
  fail("Working tree has uncommitted changes. Commit or intentionally stash them before switching machines.");
}

if (ahead > 0) {
  fail(`Local branch has ${ahead} commit(s) not pushed to GitHub.`);
}

if (behind > 0) {
  fail(`Local branch is ${behind} commit(s) behind GitHub. Pull before continuing work.`);
}
